...
// The word "public" is a Java keyword which is called an access modifier
// What does an access modifier do: it allows us to define which parts of our code, or even someone else's code, can access a particular element
public class FirstClass { 
    // what is a method: a collection of statements, one or more, that perform an operation.
